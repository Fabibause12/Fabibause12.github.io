...
document.addEventListener("DOMContentLoaded", function() {
    ...
    cube.addEventListener("click", function() {
        ...
        const degreesToRotateY = 360 * 5 + (90 * (random1 - 1)); // Mindestens 1800 Grad plus die Drehung zur ausgewählten Seite
        const degreesToRotateX = 360 * 5 + (90 * (random2 - 1)); // Mindestens 1800 Grad plus die Drehung zur ausgewählten Seite
